    ...
    public class BankTransactionTrainingService
    {
        ...
        private IEstimator<ITransformer> LoadDataProcessPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext
                ...
                .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName: nameof(TransactionData.Information), outputColumnName: "TitleFeaturized"))
                .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName: nameof(TransactionData.CreditDebitIndicator), outputColumnName: "DescriptionFeaturized"))
